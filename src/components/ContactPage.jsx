...
function ContactPage() {
    ...
    <div className="container px-6 mx-auto">
        <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold text-white md:text-4xl font-redhat">We're Eager to Connect: Let's Paint <br/>Your Ideas Together! 🎨✨</h1>

            <p className="mt-3 text-[#e6e6e6] font-inter">We’d love to hear from you. Please fill out this form or shoot us an email.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div className="bg-black py-4 px-4 rounded-lg">
                    ...
                    <h2 className="mt-4 text-base font-bold text-gray-100">Email</h2>
                    <p className="mt-2 text-sm text-[#e6e6e6] dark:text-gray-400">Our friendly team is here to help.</p>
                    <p className="mt-2 text-sm text-blue-500 ">art@taba.co.in</p>
                </div>
                ...
                <div className="bg-black py-4 px-4 rounded-lg">
                    ...
                    <h2 className="mt-4 text-base font-bold text-gray-100">Office</h2>
                    <p className="mt-2 text-sm text-[#e6e6e6] dark:text-gray-400">Come say hello at our office HQ.</p>
                    <p className="mt-2 text-sm text-blue-500 ">F-10/22 Ground floor near Moosa Apartment-Jogi Bai <br/>extension Jamiya nagar South Delhi 110025</p>
                </div>
                ...
                <form>
                    <div className="-mx-2 md:items-center md:flex">
                        ...
                        <div className="flex-1 px-2 mt-4 md:mt-0">
                            <label className="block mb-2 text-sm text-black">Last Name</label>
