...
function Navbar() {
  return (
    <div className=' z-[999] w-full shadow-lg bg-red-400 '>
<nav className="bg-[#19345f] w-full ">
  ...
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" className="text-white bg-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-4 py-2 text-center dark:bg-black border-solid border-2 border-white" style={{background:"#19345f"}}>Get started</button>
