...
</svg>} infoText={'Introducing Vikash Mandal, the co-founder with a unique academic journey. A graduate from Delhi University with a BA, Vikash pursued his MA through open education. His path in art was far from conventional, fueled by a determination to navigate the challenges of peer pressure that discouraged an artistic education. Vikash’s story is a testament to choosing passion over conformity. Despite the pressure steering him away from the arts, he embraced his creative spirit. Now, as a co-founder of the website, Vikash invites you to witness a narrative where education and art converge in unexpected ways. Explore his academic chapters, where every qualification is a brushstroke defying societal expectations. Vikash Mandal’s journey unfolds on this digital canvas, where art becomes a powerful declaration against the currents of conformity. Join him in celebrating the triumph of individuality and creativity on their website.'} imgLink={'https://firebasestorage.googleapis.com/v0/b/taba-5c32a.appspot.com/o/media%2FFounder%20photos%2FVikas_photo.webp?alt=media&token=18f97f3b-2ff4-49b7-9195-8952436695ec'} alt={'Vikas Mandal founder of TABA'} />
