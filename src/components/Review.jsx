	...
	<div className="container px-6 py-12 mx-auto">
		<div className="grid items-center gap-4 xl:grid-cols-5">
			<div className="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left">
				<h2 className="text-4xl xl:text-6xl font-redhat text-yellow-100 font-extrabold">Reviews And Testimonials</h2>
				...
				<div className="grid gap-4 md:grid-cols-2">
					<div className="grid content-center gap-4">
						...
						<div className="p-6 rounded shadow-md dark:bg-gray-900 bg-black text-white">
							<p className='font-lg '>Sit wisi sapientem ut, pri civibus temporibus voluptatibus et, ius cu hinc fabulas. Nam meliore minimum et, regione convenire cum id. Ex pro eros mucius consectetuer, pro magna nulla nonumy ne, eam putent iudicabit consulatu cu.</p>
							<div className="flex items-center mt-4 space-x-4">
