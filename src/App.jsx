...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: (
          <BookNowPage
            title={"Book now by filling this form"}
            smallText={
              <>
                <p className="text-[#aaaaaa]">
                  All the fields are <i className="text-white">mandatory</i> and
                  should be filled <i className="text-white">correctly</i>
                </p>
                <small className="text-[#aaaaaa] font-bold">
                  Currently available in Delhi only
                </small>
              </>
            }
          />
      ...
      {
        path: "ourwork/sculpturework/:id",
        element: <SculptureWorkDetails />,
      },
