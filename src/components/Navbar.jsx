...
<nav className="bg-white dark:bg-gray-900  w-full z-20 top-0 start-0 " style={divStyle}>
  ...
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" className="text-white bg-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-4 py-2 text-center dark:bg-black ">Get started</button>
