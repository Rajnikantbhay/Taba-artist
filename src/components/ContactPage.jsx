...
function ContactPage() {
    return (
        <div className="bg-red-400 h-96 w-full my-12 img-container">
            {/* <img src={Imgone} alt="" className="w-full h-full object-cover" /> */}
            <div className="w-full flex items-center justify-center">
                <div className="top-40 bg-white shadow rounded py-12 lg:px-28 px-8 mt-10">
                    ...
                    <div>
                        <div className="w-full flex flex-col mt-8">
                            ...
                            <textarea tabIndex={0} aria-label="leave a message" type="name" className="h-36 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100 resize-none" defaultValue={""} />
                        </div>
                    </div>
