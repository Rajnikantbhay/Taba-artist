...
const LINKS = [
  {
    title: "Our Work",
    items: [
      { item: "Wall Art", href: "/ourwork#muralart" },
  ...
  },
  {
    ...
    items: [
      {
        item: "+91-9911-499221",
        href: <ContactButton phoneNumber={9911499221} />,
      },
      {
        item: "+91-9560-615712",
        href: <ContactButton phoneNumber={9560615712} />,
      },
      {
        item: "art@taba.co.in",
        href: <EmailButton email={`art@taba.co.in`} />,
      },
    ],
  },
];
    ...
    <footer className="relative w-full bg-black pt-5 ">
      <div className="mt-auto mx-auto w-full max-w-7xl md:px-8 px-4">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <Typography
            variant="h5"
            className="mb-6 font-redhat text-yellow-100 flex items-center"
          >
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear}{" "}
            <a href="https://material-tailwind.com/">TABA</a>. All Rights
            Reserved.
          </Typography>
          <div className="md:mr-12">
            <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
              <Typography
                ...
                href="https://www.youtube.com/@TABATheArtByArtist"
              ...
              <Typography
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.instagram.com/taba.co.in?igsh=ODA1NTc5OTg5Nw%3D%3D"
